...
def main():
    ...
    card_methods = [method for method in Card.__dict__ if not method.startswith("_")]
    com_methods = [
        method for method in Combatable.__dict__ if not method.startswith("_")
    ]
    magical_methods = [
        method for method in Magical.__dict__ if not method.startswith("_")
    ]
